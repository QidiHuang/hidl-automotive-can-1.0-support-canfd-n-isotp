...
CanBusNative::CanBusNative(const std::string& ifname, uint32_t bitrate, uint32_t bitsamplepoint, uint32_t dbitrate, uint32_t dbitsamplepoint)
    : CanBus(ifname), mBitrate(bitrate), mBitSamplePoint(bitsamplepoint), mDBitrate(dbitrate), mDBitSamplePoint(dbitsamplepoint) {}
