...
Extensions are done based on Android12, but since the HIDL CAN HAL doesn't change (only can/1.0 exists) in following Android versions,

this piece of code also can be applied to Android13, 14, 15, 16, etc..
